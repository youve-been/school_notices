...
posting_channel = '#컴공_일반공지'
myToken = "[bot_token]"
 
#getting infos and posting at Slack
def job():
    rfp = open('db_cs_notice3.txt', 'r')

    from bs4 import BeautifulSoup as bs

    page = requests.get("https://scc.sogang.ac.kr/front/cmsboardlist.do?siteId=cs&bbsConfigFK=1746")
    ...
    wfp = open('db_cs_notice3.txt', 'w', encoding='UTF-8')
    wfp.write('\n'.join(posting))
    wfp.close()
